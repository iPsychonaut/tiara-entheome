...
> This file preserves the original upstream Tiara README verbatim. It refers to
> the original `tiara` command and the upstream `ibe-uw/tiara` project. For the
> fork-specific documentation, see [README.md](README.md).
